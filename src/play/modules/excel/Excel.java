...
public class Excel {
    ...
    private String getTemplateName_(String templateName) {
     ...
     *            The template data
     */
    public static void renderTemplateAsExcel(String templateName,
            Object... args) {
        ...
        Object fileName = templateBinding.get("fileName");
        if (null == fileName) {
            templateBinding.put("fileName",
        ...
        try {
            throw new RenderExcelTemplate(templateName + ".xls",
                    templateBinding.data, templateBinding.get("fileName")
                            .toString());
